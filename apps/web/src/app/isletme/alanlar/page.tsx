...
export default async function AlanlarPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">Alanlar</h1>
      <p className="mt-1 text-sm text-zinc-600">
        Salon, bahçe, teras gibi alanlarınızı yönetin. Masalar bir alana bağlıdır.
      </p>

      <div className="mt-6">
        <SimpleEntityManager table="areas" entityLabel="Alan" items={areas ?? []} />
      </div>
    </div>
  );
}
